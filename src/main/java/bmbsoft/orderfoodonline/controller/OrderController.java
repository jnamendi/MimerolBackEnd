...
//			}
            ...
            if (req.getZoneId() != null) {
                ...
                req.setDistrict(model.getDistrict().getName());
                req.setCity(model.getDistrict().getCity().getName());
            }
                    ...
                    if (cm != null) {
                        ...
                        if (req.getLanguageCode().equals("en")) {
                            switch (req.getPaymentType()) {
                                case 1:
                                    vars.put("paymentType", Constant.CASH_EN);
                                    break;
                                case 2:
                                    vars.put("paymentType", Constant.VISA_EN);
                                    break;
                                case 3:
                                    vars.put("paymentType", Constant.PAYPAL_EN);
                                    break;
                                case 4:
                                    vars.put("paymentType", Constant.CREDIT_DEBIT_ON_DELIVERY_EN);
                                    break;
                            }
                        } else {
                            switch (req.getPaymentType()) {
                                case 1:
                                    vars.put("paymentType", Constant.CASH_ES);
                                    break;
                                case 2:
                                    vars.put("paymentType", Constant.VISA_ES);
                                    break;
                                case 3:
                                    vars.put("paymentType", Constant.PAYPAL_ES);
                                    break;
                                case 4:
                                    vars.put("paymentType", Constant.CREDIT_DEBIT_ON_DELIVERY_ES);
                                    break;
                            }
                        }
                        ...
                        if (typeOfMail == Constant.EmailType.OrderConfirmed.getValue()) {
                            ...
                            if (req.getLanguageCode().equals("en")) {
                                switch (or.getPaymentType()) {
                                    case 1:
                                        map.put("paymentType", Constant.CASH_EN);
                                        break;
                                    case 2:
                                        map.put("paymentType", Constant.VISA_EN);
                                        break;
                                    case 3:
                                        map.put("paymentType", Constant.PAYPAL_EN);
                                        break;
                                    case 4:
                                        map.put("paymentType", Constant.CREDIT_DEBIT_ON_DELIVERY_EN);
                                        break;
                                }
                            } else {
                                switch (or.getPaymentType()) {
                                    case 1:
                                        map.put("paymentType", Constant.CASH_ES);
                                        break;
                                    case 2:
                                        map.put("paymentType", Constant.VISA_ES);
                                        break;
                                    case 3:
                                        map.put("paymentType", Constant.PAYPAL_ES);
                                        break;
                                    case 4:
                                        map.put("paymentType", Constant.CREDIT_DEBIT_ON_DELIVERY_ES);
                                        break;
                                }
                            }
